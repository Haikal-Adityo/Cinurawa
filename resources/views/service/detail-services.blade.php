...
<body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-7 text-end">
                    <div class="hero-card">
                        <img src="assets/img/hero.png" alt="Judul Profil" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="detail-services pt-5">
        <div class="sub-heading">
            This is Subheader
        </div>
        <h2 class="mb-3">This is Header</h2>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 frame">
                    <img src="assets/img/portfolio/portfolio1.png" alt="" class="img-fluid">
                </div>

                <div class="col-md-4 frame">
                    <img src="assets/img/portfolio/portfolio2.png" alt="" class="img-fluid">
                </div>
