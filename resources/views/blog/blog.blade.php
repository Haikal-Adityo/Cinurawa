...
<body>
            ...
            <div class="row search-container">
                <div class="col-md-8">
                    <div class="row row-search">
                        ...
                        <div class="col"><a href="blog-category.html">Property</a></div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <a href="blog-detail.html">
                        <img src="{{ url('/img/blogs/property.png') }}" alt="" class="img-fluid">
                        <img src="{{ url('/img/blogs/property-label.png') }}" alt="" class="img-blog-label">
                        <div class="title">What is your favorite leather jacket color</div>
                        <div class="sub-title">6 month ago</div>
                    </a>
                </div>
                <div class="col-md-4">
                    <img src="{{ url('/img/blogs/financial.png') }}" alt="" class="img-fluid">
                    ...
                    <div class="sub-title">13 hours ago</div>
                </div>
                <div class="col-md-4">
                    <img src="{{ url('/img/blogs/architecture.png') }}" alt="" class="img-fluid">
                    <img src="{{ url('/img/blogs/architecture-label.png') }}" alt="" class="img-blog-label">
                    <div class="title">Lorem ipsum dolor sit amet, consectetur adipiscing elit</div>
                    <div class="sub-title">1 day ago</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="blog-content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <img src="{{ url('/img/blogs/financial/1.png') }}" alt="" class="img-fluid">
                    <img src="{{ url('/img/blogs/financial-label.png') }}" alt="" class="img-blog-label">
                    <div class="title">Lorem ipsum dolor sit amet, consectetur adipiscing elit</div>
                    <div class="sub-title">13 hours ago</div>
                </div>
                <div class="col-md-6">
                    <img src="{{ url('/img/blogs/financial/2.png') }}" alt="" class="img-fluid">
                    <img src="{{ url('/img/blogs/financial-label.png') }}" alt="" class="img-blog-label">
                    <div class="title">Lorem ipsum dolor sit amet, consectetur adipiscing elit</div>
                    <div class="sub-title">13 hours ago</div>
                </div>
            ...
            <div class="row  mt-5">
                <div class="col-md-4">
                    <img src="{{ url('/img/blogs/financial/3.png') }}" alt="" class="img-fluid">
                    <img src="{{ url('/img/blogs/financial-label.png') }}" alt="" class="img-blog-label">
                    <div class="title">What is your favorite leather jacket color</div>
                    <div class="sub-title">6 month ago</div>
                </div>
                <div class="col-md-4">
                    <img src="{{ url('/img/blogs/financial/4.png') }}" alt="" class="img-fluid">
                    <img src="{{ url('/img/blogs/financial-label.png') }}" alt="" class="img-blog-label">
                    <div class="title">Lorem ipsum dolor sit amet, consectetur adipiscing elit</div>
                    <div class="sub-title">13 hours ago</div>
                </div>
                <div class="col-md-4">
                    <img src="{{ url('/img/blogs/financial/5.png') }}" alt="" class="img-fluid">
                    <img src="{{ url('/img/blogs/financial-label.png') }}" alt="" class="img-blog-label">
                    <div class="title">Lorem ipsum dolor sit amet, consectetur adipiscing elit</div>
                    <div class="sub-title">1 day ago</div>
                </div>
