...
<head>
    ...
    <title>Design System Cinurawa</title>
...
<body>
    <p class="text-center">Typografy</p>
    <h1>Heading 1</h1>
    <h2>Heading 2</h2>
    <h3>Heading 3</h3>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <img src="assets/img/logo.svg" alt="" srcset="" class="mb-3">
                    <div class="reguler-text">
                        +62 857-0275-0455 <br>
                    ...
                    <div class="mt-24">
                        <img src="assets/img/icon-medsos/facebook.svg" alt="" srcset="" class="icon-medsos">
                        <img src="assets/img/icon-medsos/twitter.svg" alt="" srcset="" class="icon-medsos">
                        <img src="assets/img/icon-medsos/instagram.svg" alt="" srcset="">
                    </div>
                </div>
